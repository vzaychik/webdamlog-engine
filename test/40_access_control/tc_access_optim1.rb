...
fact local1@p1(3);
  ...
  def test_extensional_optim1
    begin
      ...
      assert_equal [{:atom1=>"1", :atom2=>"3", :priv=>"G", :plist=>Omega.instance},{:atom1=>"1",:atom2=>"3", :priv=>"R", :plist=>Omega.instance},{:atom1=>"2", :atom2=>"3", :priv=>"G", :plist=>Omega.instance},{:atom1=>"2",:atom2=>"3", :priv=>"R", :plist=>Omega.instance}], runner2.tables[:delegated_join_plus_at_p1].map{ |t| Hash[t.each_pair.to_a] }

      assert_equal [{:atom1=>"1", :atom2=>"3", :priv=>"G", :plist=>Omega.instance},{:atom1=>"1",:atom2=>"3", :priv=>"R", :plist=>Omega.instance},{:atom1=>"2", :atom2=>"3", :priv=>"G", :plist=>Omega.instance},{:atom1=>"2",:atom2=>"3", :priv=>"R", :plist=>Omega.instance}], runner1.tables[:local3_plus_at_test_access].map{ |t| Hash[t.each_pair.to_a] }
